...
@section('content')
    <div class="container mx-auto px-20 mt-20">
        ...
        <form action="{{route('admin.users.update', $user->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="department_id" class="block mb-2 font-medium ">Department</label>
            ...
            {{-- <div class="mb-4">
                <label for="passsword" class="block mb-2 font-medium ">New Password</label>
            ...
            <div class="mb-4">
                <label for="password_confirmation" class="block mb-2 font-medium ">Confirm New Password</label>
