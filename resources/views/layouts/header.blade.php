...
<head>
	...
	<title>Home - Team Unity Admin</title>
...
<div class="main-menu">
	<header class="header">
		<a href="index.html" class="logo">Team Unity</a>
		<button type="button" class="button-close fa fa-times js__menu_close"></button>
		<div class="user">
			{{-- <a href="#" class="avatar"><img src="{{asset('storage/images/'.$user->image)}}" alt=""><span class="status online"></span></a> --}}
			<a href="#" class="avatar"><img src="{{asset('adminpanel/assets/images/admin.png')}}" alt=""><span class="status online"></span></a>
